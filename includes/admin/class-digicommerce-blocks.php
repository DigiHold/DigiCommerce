...
class DigiCommerce_Blocks {
	...
	public function register_blocks() {
		...
		register_block_type('digicommerce/archives', array(
			'apiVersion' => 2,
									...
									if ($attributes['showPrice']) :
										if ($price_mode === 'variations') :
												...
												if (!empty($prices)) :
													...
													<div class="product-prices">
														...
														if ($lowest_sale && $lowest_sale < $lowest_regular) {
															echo $product->format_price($lowest_sale, 'normal-price');
															echo $product->format_price($lowest_regular, 'regular-price');
														} else {
															echo $product->format_price($lowest_regular, 'normal-price');
														}
														?>
													</div>
													<?php
											...
											if ($sale_price && $sale_price < $price) : ?>
												<div class="product-prices">
													<?php
													echo $product->format_price($sale_price, 'normal-price');
													echo $product->format_price($price, 'regular-price');
													?>
												</div>
												<?php
											else :
												echo $product->format_price($price, 'normal-price');
											endif;
										endif;
									endif; ?>
								</div>
