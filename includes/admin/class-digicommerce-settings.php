...
class DigiCommerce_Settings {
	...
	public function render_settings_page() {
		...
		if ( ! class_exists( 'DigiCommerce_Pro' ) ) {
			$tabs['addons'] = esc_html__( 'Addons Pro', 'digicommerce' );
		}
					...
					<?php foreach ( $tabs as $tab_id => $tab_label ) : ?>
						...
						?>
							...
							<span class="relative">
								...
								<?php if ( 'addons' === $tab_id ) : ?>
									<div class="digicommerce-tab-icon">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="15" height="15" fill="#ccb161"><path d="m2.8373 20.9773c-.6083-3.954-1.2166-7.9079-1.8249-11.8619-.1349-.8765.8624-1.4743 1.5718-.9422 1.8952 1.4214 3.7903 2.8427 5.6855 4.2641.624.468 1.513.3157 1.9456-.3333l4.7333-7.1c.5002-.7503 1.6026-.7503 2.1028 0l4.7333 7.1c.4326.649 1.3216.8012 1.9456.3333 1.8952-1.4214 3.7903-2.8427 5.6855-4.2641.7094-.5321 1.7067.0657 1.5719.9422-.6083 3.954-1.2166 7.9079-1.8249 11.8619z"></path><path d="m27.7902 27.5586h-23.5804c-.758 0-1.3725-.6145-1.3725-1.3725v-3.015h26.3255v3.015c-.0001.758-.6146 1.3725-1.3726 1.3725z"></path></svg>
									</div>
								<?php endif; ?>
							</span>
						</a>
	...
	private function render_addons_tab() {
		...
		<div class="blocs grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 4xl:grid-cols-4 gap-8 w-full">
			<?php
			$blocs = array(
				'subscriptions'   => array(
				...
				'programs'        => array(
					...
					'description' => esc_html__( 'Transform your website into a complete e-learning solution with courses, lessons, and student management tools.', 'digicommerce' ),
					'viewbox'     => '0 0 640 512',
				...
				's3'              => array(
					...
					'description' => esc_html__( 'Optimize your file delivery by offloading files to Amazon S3, ensuring secure, efficient access while significantly reducing server load.', 'digicommerce' ),
					'viewbox'     => '0 0 640 512',
			...
			foreach ( $blocs as $id => $bloc ) :
				...
				<div class="flex flex-col items-center border border-solid border-gray-200 rounded-md overflow-hidden">
					...
					<div class="mt-auto w-full">
						<a class="digi__button" href="https://digicommerce.me/<?php echo esc_attr( $id ); ?>/?utm_source=WordPress&amp;utm_medium=settings&amp;utm_campaign=digi" target="_blank" rel="noopener noreferrer" class="default-transition">
