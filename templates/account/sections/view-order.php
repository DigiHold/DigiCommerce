 ...
 *
 * This template can be overridden by copying it to yourtheme/digicommerce/account/sections/view-order.php
 *
 * @version 1.0.0
 */
								...
								<div class="inline-flex flex-col gap-2">
									...
									if ( $product_id && $order_id ) {
										...
										if ( $is_bundle_item ) {
											...
											?>
											<div class="no-invoice flex flex-col items-start gap-4">
												...
												?>
													<div class="flex flex-col gap-2 pl-4 border-l-2 border-dark-blue-20">
														...
														if ( !empty( $bundle_files ) ) :
															...
															elseif ( count( $downloadable_files ) === 1 ) :
																...
																<button type="button" 
																	...
																	<span class="text flex-grow"><?php printf( esc_html__( 'Download %s', 'digicommerce' ), esc_html( $file_name ) ); ?></span>
																</button>
																<?php
															endif;
														else :
