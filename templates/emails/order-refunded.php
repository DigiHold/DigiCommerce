 ...
 *
 * This template can be overridden by copying it to yourtheme/digicommerce/emails/order-refunded.php
 *
 * @version 1.0.0
 */
...
<body>
	<div class="container">
		...
		<div class="content">
			<h2><?php esc_html_e( 'Order Refunded', 'digicommerce' ); ?></h2>
			...
			<div class="refund-notice">
				<p>
					...
					printf(
						/* translators: %s: order number */
						esc_html__( 'Your order %s has been refunded.', 'digicommerce' ),
			...
			<div class="order-info">
				...
				<p class="status-badge"><?php esc_html_e( 'Refunded', 'digicommerce' ); ?></p>
			</div>
			...
			<p>
				<?php esc_html_e( 'The refunded amount will be returned to your payment method within a few business days. Please contact your bank or payment provider if you experience any delays.', 'digicommerce' ); ?>
			</p>
